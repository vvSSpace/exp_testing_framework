...
@allure.title("Проверка выхода из учётной записи пользователя на всех устройствах")
@allure.severity(allure.severity_level.NORMAL)
def test_del_v1_account_login_all(dm_api_facade, dm_orm_db, prepare_user):
    ...
    dm_api_facade.login.logout_user_from_all_devices(status_code=204)
